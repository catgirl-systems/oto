...
<p align="center">
  ...
  <a href="https://github.com/catgirl-systems/oto/releases/tag/v0.5.0"><img src="https://img.shields.io/badge/coverage%20v0.5.0-75.7%25-green" alt="Statement coverage: 75.7% at v0.5.0"></a>
...
The last command opens the TUI; quitting it leaves transfers running. The image includes ffmpeg and supports amd64/arm64. Pin `:0.5.0` instead of `:latest` to avoid automatic version changes when pulling.
