...
<p align="center">
  ...
  <a href="https://github.com/catgirl-systems/oto/releases/tag/v0.4.1"><img src="https://img.shields.io/badge/coverage%20v0.4.1-75.2%25-green" alt="Statement coverage: 75.2% at v0.4.1"></a>
...
The last command opens the TUI; quitting it leaves transfers running. The image includes ffmpeg and supports amd64/arm64. Pin `:0.4.1` instead of `:latest` to avoid automatic version changes when pulling.
